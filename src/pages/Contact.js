      ...
      <form className="flex flex-col items-center text-sm text-slate-800">
            ...
            <div className="max-w-96 w-full px-4">
                ...
                <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-black/80 transition-all overflow-hidden">
                    <img src={myAssets.user} width={19} className='invert-50' />
                ...
                <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-black/80 transition-all overflow-hidden">
                    <img src={myAssets.mail} width={18} className='invert-50' />
                ...
                <textarea rows="4" className="w-full mt-2 p-2 bg-transparent border border-slate-300 rounded-lg resize-none outline-none focus:ring-2 focus-within:ring-black/80 transition-all" placeholder="Enter your message" required></textarea>
                
                <button type="submit" className="flex items-center justify-center gap-1 mt-5 btn-solid w-full !font-bold">
                    Submit Form
                    <img src={myAssets.right} className='invert' />
                </button>
            </div>
        </form>
    </div>
